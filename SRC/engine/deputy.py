...
class DeputyProvisionalChanges:
    ...
    def moveNode(self, node, position, deputy):
        ...
        ## TODO: Should this be neighborElements or
        ## aperiodicNeighborElements?  There didn't used to be a
        ## distinction.  Now that there is, maybe the callers of this
        ## routine can be simplified.
        for el in node.aperiodicNeighborElements():
