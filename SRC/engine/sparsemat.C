...
//#define SMDEBUG
#ifdef SMDEBUG
static std::set<const SparseMatCore*> allcores;
#endif
...
// #ifdef SMDEBUG
//   assert(allcores.find(this) != allcores.end());
//   allcores.erase(this);
//   assert(allcores.find(this) == allcores.end());
// #endif
...
void SparseMatCore::consolidate_row(unsigned int rdx) {
  ...
  if (startsize > 1 ) {
    ...
    SparseMatRow *newrow = new SparseMatRow();
...
{
#ifdef SMDEBUG
  assert(allcores.find(mat.core) != allcores.end());
#endif
