...
words['Credits'] = """
OOF2 was written at the National Institute of Standards and Technology in Gaithersburg, Maryland, USA, by Stephen A. Langer, Andrew C.E. Reid, Valerie R. Coffman, Gunay Dogan, Rhonald C. Lua, R. Edwin Garcia, Seung-Ill Haan, and Eric Ma.

OOF2 is a product of the NIST Information Technology Laboratory and the Center for Theoretical and Computational Materials Science in the NIST Materials Science Laboratory.
