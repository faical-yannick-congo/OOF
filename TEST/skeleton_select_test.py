...
class Skeleton_Element_Group(Direct_Element_Selection):
    ...
    def Auto_Group(self):
        ...
        self.assertEqual(len(self.e_groups.get_group("group0")), 15)
        self.assertEqual(len(self.e_groups.get_group("group1")), 9)
        self.assertEqual(len(self.e_groups.get_group("group2")), 7)
        self.assertEqual(len(self.e_groups.get_group("group3")), 1)
        self.assertEqual(len(self.e_groups.get_group("group4")), 2)
        self.assertEqual(len(self.e_groups.get_group("group5")), 14)
        self.assertEqual(len(self.e_groups.get_group("group6")), 8)
        self.assertEqual(len(self.e_groups.get_group("group7")), 8)
...
class Skeleton_Segment_Group(Direct_Segment_Selection):
    ...
    def Auto_Group(self):
        ...
        self.assertEqual(len(self.s_groups.get_group("group0")), 27)
        self.assertEqual(len(self.s_groups.get_group("group1")), 22)
        self.assertEqual(len(self.s_groups.get_group("group2")), 17)
        self.assertEqual(len(self.s_groups.get_group("group3")), 3)
        self.assertEqual(len(self.s_groups.get_group("group4")), 9)
        self.assertEqual(len(self.s_groups.get_group("group5")), 30)
        self.assertEqual(len(self.s_groups.get_group("group6")), 18)
        self.assertEqual(len(self.s_groups.get_group("group7")), 18)
...
class Skeleton_Node_Group(Direct_Node_Selection):
    ...
    def Auto_Group(self):
        ...
        self.assertEqual(len(self.n_groups.get_group("group0")), 15)
        self.assertEqual(len(self.n_groups.get_group("group1")), 13)
        self.assertEqual(len(self.n_groups.get_group("group2")), 10)
        self.assertEqual(len(self.n_groups.get_group("group3")), 3)
        self.assertEqual(len(self.n_groups.get_group("group4")), 4)
        self.assertEqual(len(self.n_groups.get_group("group5")), 15)
        self.assertEqual(len(self.n_groups.get_group("group6")), 10)
        self.assertEqual(len(self.n_groups.get_group("group7")), 11)
