...
findWidget('Dialog-Rename pixelgroup #ffff00').resize(194, 72)
...
findWidget('Dialog-Rename pixelgroup #ffff00:gtk-ok').clicked()
findWidget('OOF2:Microstructure Page:Pane:PixelGroups:GroupListScroll:GroupList').get_selection().select_path((1,))
# checkpoint interface page updated
checkpoint meshable button set
checkpoint microstructure page sensitized
...
findWidget('Dialog-Rename pixelgroup #00ffff').resize(194, 72)
findWidget('Dialog-Rename pixelgroup #00ffff:new_name').set_text('')
findWidget('Dialog-Rename pixelgroup #00ffff:new_name').set_text('x')
checkpoint microstructure page sensitized
findWidget('Dialog-Rename pixelgroup #00ffff:new_name').set_text('xy')
findWidget('Dialog-Rename pixelgroup #00ffff:new_name').set_text('xyN')
findWidget('Dialog-Rename pixelgroup #00ffff:new_name').set_text('xy')
checkpoint meshable button set
findWidget('Dialog-Rename pixelgroup #00ffff:new_name').set_text('x')
findWidget('Dialog-Rename pixelgroup #00ffff:new_name').set_text('')
...
findWidget('Dialog-Rename pixelgroup #00ffff:gtk-ok').clicked()
findWidget('OOF2:Microstructure Page:Pane:PixelGroups:GroupListScroll:GroupList').get_selection().select_path((0,))
# checkpoint interface page updated
checkpoint meshable button set
checkpoint microstructure page sensitized
